...
<head>
    ...
    <title>Base de compradores</title>
        ...
        <div class="container-fluid">
            <div class="table-container">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php if (!empty($comprador)) { ?>
                            <?php foreach ($comprador as $fila) { ?>
                                <tr>
                                  <th scope="row"><?php echo $fila['id_compra']; ?></th>
                                  <td><?php echo $fila['correo_comprador']; ?></td>
                                  <td><?php echo $fila['nombre_comprador']; ?></td>
                                  <td><?php echo $fila['apellido_paterno_comprador']; ?></td>
                                  <td><?php echo $fila['apellido_materno_comprador']; ?></td>
                        ...
                        <?php } else { ?>
                            <tr>
                                <td colspan="6" style="text-align: center;">No hay compradores</td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
