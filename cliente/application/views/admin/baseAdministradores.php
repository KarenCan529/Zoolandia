                    ...
                    <tbody>
                        <?php if (!empty($administradores)) { ?>
                            <?php foreach ($administradores as $fila) { ?>
                                <tr>
                                    <th scope="row"><?php echo $fila['id_administrador']; ?></th>
                                    <td><?php echo $fila['nombre_administrador']; ?></td>
                                    <td><?php echo $fila['apellido_paterno_administrador']; ?></td>
                                    <td><?php echo $fila['apellido_materno_administrador']; ?></td>
                                    <td><?php echo $fila['correo_administrador']; ?></td>
                                    <td><?php echo $fila['password_administrador']; ?></td>
                                </tr>
                            <?php } ?>
                        <?php } else { ?>
                            <tr>
                                <td colspan="6" style="text-align: center;">No hay administradores registrados.</td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
